...
// allowing the fragment shader to access several textures concurrently
...
// This function calculates the texture color based on the height of the terrain at the current fragment.
// NOTE: This is the table in your notes for texture tiling.
vec4 CalcTexColor()
{
    vec4 TexColor;
...
void main() {
    ...
    FragColor = Color * TexColor; // color of the texture is modulated by the Color attribute (makes dark spots in lower areas)
}