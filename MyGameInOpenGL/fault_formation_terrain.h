...
class FaultFormationTerrain : public BaseTerrain {
 ...
 public:
	...
	// needs TerrainSize, can not be calculated since we are now creating a heightmap from scratch, and not loading it from a file
	// Iterations = how many times the fault formation algorithm will be applied, more iterations = more detailed terrain
